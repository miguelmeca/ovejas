...
public class EliminarOvejaCorral extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Agrega la oveja seleccionada a la grilla

        //tendriamos que evaluar que vamos a hacer con las ovejas que ya estan en un corral
        //las sacamos del otro directamente o se le avisa al usuario que se esta haciendo eso

        Integer ovejaRP = (Integer) jComboBox1.getSelectedItem();
        OvejaJpaController ojc = new OvejaJpaController();
        Oveja oveja = ojc.findOvejaPorRP(ovejaRP);

        jTable1.setValueAt(oveja.getOvejarp(), 2, 0);
        jTable1.setValueAt(oveja.getOvejasexo(), 2, 1);
        jTable1.setValueAt(oveja.getOvejafechaalta(), 2, 2);
        jTable1.setValueAt(oveja.getOvejapeso(), 2, 3);
